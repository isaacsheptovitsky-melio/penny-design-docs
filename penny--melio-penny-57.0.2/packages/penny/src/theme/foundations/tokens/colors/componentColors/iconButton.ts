import { type Parts, type States, type TokenValue, type Variants } from './button';

type IconButtonTokensByPart = Record<Parts, TokenValue>;
type IconButtonPartsByState = Record<States, IconButtonTokensByPart>;
export type IconButtonColors = Record<Variants, IconButtonPartsByState>;

export const iconButtonColors: IconButtonColors = {
  primary: {
    rest: {
