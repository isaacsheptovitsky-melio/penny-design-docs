...
import { type SelectNewOption, type SelectNewSection } from '../SelectNew.types';
import { checkHasSections, getFlatIndex, getFlatOptions } from '../SelectNew.utils';

describe('SelectNew - utils', () => {
  ...
  describe('getFlatIndex', () => {
    it('should return the flat index of an option within a sectioned options array', () => {
      const sectionedOptions: SelectNewSection<string, SelectNewOption<string>>[] = [
        {
          label: 'Section 1',
          options: [
